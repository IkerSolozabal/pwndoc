...
async function prepAuditData(data, settings) {
    ...
    result.criticity = data.criticity || "undefined"
    result.recommendation = data.recommendation || "undefined"
    ...
    data.client.forEach(cli => {
        result.client.push({
            ...
            firstname: cli.firstname || "undefined",
            lastname: cli.lastname || "undefined",
            phone: cli.phone || "undefined",
            cell: cli.cell || "undefined",
            title: cli.title || "undefined"
        })
    })
    ...
    for (var finding of data.findings) {
        ...
        var tmpFinding = {
            ...
            references: await splitHTMLParagraphs(finding.references),
